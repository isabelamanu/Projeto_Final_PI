...
urlpatterns = [
    ...
    path(
        "gerenciar/criar/", views.create_usuario_admin, name="create_usuario_admin"
    ),  # para administrador criar usuário
    path(
        "gerenciar/editar/<int:id>/", views.update_usuario_admin, name="update_usuario_admin"
    ),  # para administrador editar usuário
]
